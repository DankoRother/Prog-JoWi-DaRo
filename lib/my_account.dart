...
class _MyAccountState extends State<MyAccountState> {
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => _buildEditAccountPage(context), // Pass context
                ),
              );
            },
          ),
  ...
  Widget _buildEditAccountPage(BuildContext context) { // Pass context here
              ...
              children: [
                ...
                ElevatedButton(
                  style: ButtonStyle(
                      ...
                      WidgetStateProperty.all(Colors.blue[900])),
                  onPressed: () {
                    // TODO: Implement database logic here to save changes
                    // Only after saving, update the state and navigate back

                    // Update the state with the new values from the controllers
                    setState(() {
